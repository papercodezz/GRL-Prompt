...
def get_question_text(problem, option_inds):
    ...
    the_question=""
    if len(context) > 0:
        the_question = f"Please read the following text carefully and then answer the subsequent question. Ensure that your response starts with \"Answer:\n\" and provides a clear and concise explanation.\n\nText:\n{context}\n\nQuestion:\n{question}"
    else:
...
def create_one_example(format, table, question, answer, solution, test_example=True):
    ...
    elements = {
        "Q": f"{question}",
        "T": f"Please read the following text carefully and then answer the subsequent question. Ensure that your response starts with \"Answer: \" and provides a clear and concise explanation.\n\nText:\n{table}\n",
